...
insert into sys_menu values('111',  '数据监控', '2', '3', 'druid',         'monitor/druid/index', 1, 0,  'C', 0, 0, 'monitor:data:list',        'druid',               'admin', now(), '', null, '数据监控菜单');
...
insert into sys_menu values('113',  '缓存监控', '2', '5', 'cache',          'monitor/cache/index', 1, 0,  'C', '0',  '0', 'monitor:cache:query',      'redis',                 'admin', now(), '', null, '缓存监控菜单');
...
-- 在线用户按钮
insert into sys_menu values('1047', '在线查询', '109', '1', '#', '',  1, 0, 'F', 0, 0, 'monitor:online:query',             '#', 'admin', now(), '', null, '');
...
-- 定时任务按钮
insert into sys_menu values('1050', '任务查询', '110', '1', '#', '',  1, 0, 'F', 0, 0, 'monitor:job:query',                '#', 'admin', now(), '', null, '');
...
-- 代码生成按钮
insert into sys_menu values('1057', '生成查询', '114', '1', '#', '',  1, 0, 'F', 0, 0, 'tool:gen:query',     '#', 'admin', now(), '', null, '');
